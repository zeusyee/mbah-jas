...
<section class="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0 bg-cover bg-center" 
         style="background-image: url('https://images.unsplash.com/photo-1504674900247-0877df9cc836?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80');">
    </div>

    <!-- Overlay agak gelap tapi tetap cerah -->
    ...
    <div class="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('menu.index') }}" class="bg-[#FFDD32] hover:bg-yellow-400 text-black px-8 py-4 rounded-lg text-lg font-semibold transition duration-300 btn-glow inline-flex items-center justify-center">
                <i class="fas fa-utensils mr-2"></i>
                Lihat Menu
            </a>
            <a href="{{ route('reservation.index') }}" class="border-2 border-[#FFDD32] text-[#FFDD32] hover:bg-[#FFDD32] hover:text-black px-8 py-4 rounded-lg text-lg font-semibold transition duration-300 inline-flex items-center justify-center">
...
<section id="featured-menu" class="py-20 bg-gradient-to-b from-gray-900 to-black">
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            @endphp
            {{-- Contoh penempatan pada home.blade.php --}}
            ...
            <div class="menu-card bg-gray-800/50 rounded-xl p-6 border border-gray-700 hover:border-green-500/50">
                ...
                <div class="text-center">
                     ...
                     <div class="flex items-center justify-between">
                          ...
                          <a href="https://wa.me/6285786695051?text=Halo, saya ingin memesan {{ $menu['name'] }}" 
        ...
        <div class="text-center">
            <a href="{{ route('menu.index') }}"  class="bg-yellow-400 hover:bg-yellow-500 text-black px-8 py-4 rounded-lg text-lg font-semibold transition duration-300 btn-glow inline-flex items-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative">
                <div class="aspect-w-16 aspect-h-12 rounded-xl overflow-hidden">
                    <img src="https://github.com/ballf327/mbah-jas-menu/blob/main/menu/jas.jpg?raw=true" alt="Warung Mbah Jas" class="w-full h-80 object-cover rounded-xl" />
                </div>
                ...
                <div class="absolute -top-6 -right-6 bg-yellow-500 text-white p-4 rounded-lg shadow-lg">
